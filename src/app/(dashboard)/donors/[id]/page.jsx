      ...
      <Tabs defaultValue="overview" className="w-full">
        ...
        <TabsContent value="overview">
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">Add notes and upcoming tasks in future iterations.</p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="interactions">
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">Interaction history to be implemented.</p>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
